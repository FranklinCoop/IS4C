...
*/
class MassStateTaxFreeOff extends FannieTask 
{
    public $name = 'Mass State Tax Free Off';

    public $description = 'Used for tax free holidays. Switches the sales tax rate to 0.0625 on each lane. 
Server side tax table remains the same.';    
