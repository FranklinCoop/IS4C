...
/****Credit for the majority of what is below for barcode generation
 ...
 webpage.****/
namespace COREPOS\Fannie\Plugin\NCGSignPilot\lib;
use \FPDF;
...
{   
    ...
    function SetCharSpacing($cs) {
        // Output the Tc operator. $this->k is the scale factor
    ...
    // returns the height of a cell based on fpdf unit default
    function getCellHeight($fontSize, $unit = 'mm') {
        switch ($unit) {
            case 'mm':
                return $fontSize*2.835;
                break;
            case 'in':
                return $fontSize/72;
                break;
