...
class PriceCheckTabletPageGFMFP extends FannieRESTfulPage
{
    ...
    protected function get_id_handler()
    {
        ...
        echo "<div class=\"col text-center\"><br /><br />
           <a href=\"PriceCheckTabletPageGFMFP.php?done=1\" class=\"btn btn-success btn-lg btn-block p-5\">Print</a>
        
        <a href=\"PriceCheckTabletPageGFMFP.php?back=1\" class=\"btn btn-danger btn-lg btn-block p-5\">Back</a>
        </div>";
    ...
    protected function get_view()
    {
        $this->addJQuery();
        $this->addBootstrap();
        $this->addScript('priceCheckTabletGFMFP.js');
        $this->addOnloadCommand("\$('#pc-upc').focus();");
        $this->addOnloadCommand("priceCheckTabletGFMFP.showDefault();");
...
<br />
<form method="get" id="pc-form" onsubmit="priceCheckTabletGFMFP.search(); return false;">
