...
class PriceCheckTabletPageNoPrint extends FannieRESTfulPage
{
    ...
    {
        $this->session->pctItems = array();
        return 'PriceCheckTabletPageNoPrint.php';
    }
    /**
    ...
    protected function get_id_handler()
    {
        ...
        <a href=\"PriceCheckTabletPageNoPrint.php?back=1\" class=\"btn btn-danger btn-lg btn-block p-5\">Back</a>
        </div>";
    ...
    protected function get_view()
    {
        $this->addJQuery();
        $this->addBootstrap();
        $this->addScript('priceCheckTabletNoPrint.js');
        $this->addOnloadCommand("\$('#pc-upc').focus();");
        $this->addOnloadCommand("priceCheckTabletNoPrint.showDefault();");
...
<br />
<form method="get" id="pc-form" onsubmit="priceCheckTabletNoPrint.search(); return false;">
