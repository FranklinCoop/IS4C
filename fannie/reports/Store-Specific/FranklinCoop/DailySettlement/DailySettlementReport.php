...
sum(case when description='17% Discount' then -unitPrice else 0 end) as staff_disc17,
sum(case when description='23% Discount' then -unitPrice else 0 end) as staff_disc23,
