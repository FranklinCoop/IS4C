...
*/
class FCCEquityReceiptMessage extends ReceiptMessage {

    public function select_condition(){
        $equityDepts = MiscLib::getNumbers(CoreLocal::get('EquityDepartments'));
        if (count($equityDepts) == 0) {
            return "SUM(CASE WHEN department=992 THEN total ELSE 0 END)";
        }
        $equityString = implode(',', $equityDepts);
    ...
    public function message($val, $ref, $reprint=False)
    {
        ...
        $slip .= ReceiptLib::biggerFont("Equity Purchase")."\n\n";
    ...
    public $standalone_receipt_type = 'eqSlip';
}
