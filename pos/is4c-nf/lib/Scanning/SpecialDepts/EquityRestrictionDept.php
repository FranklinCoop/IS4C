...
class EquityRestrictionDept extends SpecialDept 
{
    ...
    public function handle($deptID,$amount,$json)
    {
        ...
        //Check that the account is a member account
        if ($CORE_LOCAL->get("Type") == "REG") { 
            $CORE_LOCAL->set('strEntered','');
            $CORE_LOCAL->set('boxMsg','Equity can not be charged to this account.<br />Please enter a valid account');
            $json['main_frame'] = MiscLib::base_url().'gui-modules/boxMsg2.php';
