...
/**
  @class ProductSearch
  Base class for providing product search results filtered by department
*/
class DepartmentSearchSearch extends ProductSearch {
    ...
    */
    public function search($str)
    {
        ...
        $query = "SELECT p.upc, 
                    ...
                    p.scale 
                  FROM products p
                  JOIN departmentSearchList l on p.upc = l.upc AND p.store_id = l.store_id
